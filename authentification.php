...
if(isset($_SESSION['utilisateur_connecte'])) {
    ...
    echo '<input type="email" class="form-control" id="email" placeholder="Entrer votre mail" name="mail">';
    echo '<label for="pwd">Mot de passe:</label>';
    echo '<input type="password" class="form-control" id="pwd" placeholder="Entrer votre mot de passe" name="Mdp">';
